...
public class EmployeeAddressController {
     ...
     */
    @PostMapping
    public ResponseEntity<EmployeeAddress> addAddressToEmployee(
     ...
     */
    @GetMapping
    public ResponseEntity<List<EmployeeAddress>> getAllAddressesByEmployeeId(@PathVariable Long employeeId) {
        List<EmployeeAddress> addresses = employeeAddressService.getAllAddresses();
    ...
    public ResponseEntity<Void> deleteAddress(@PathVariable Long id) {
        employeeAddressService.deleteAddress(id);
